...
uint8_t IMU_GY_RANGE = 131; /**< divide by this to get degrees per second */
float ACC_RANGE = 16384.0;  /**< divide to get in units of g */
...
void MPU6050_init();
uint8_t MPU6050_READ_REG(I2C_HandleTypeDef* I2C_Handle, uint8_t reg_addr);
void MPU6050_WRITE_REG(I2C_HandleTypeDef* I2C_Handle,uint8_t reg_addr, uint8_t data);
void MPU6050_READ_DATA(I2C_HandleTypeDef* I2C_Handle, uint8_t Reg_addr, uint8_t* sensor_buffer);
