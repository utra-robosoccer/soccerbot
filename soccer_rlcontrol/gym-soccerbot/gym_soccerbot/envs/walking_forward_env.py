...
class WalkingForward(gym.Env):
    ...
    def __init__(self, renders=False):
        ...
        self.observation_space = spaces.Box(
            low=self.observation_limit_low, high=self.observation_limit_high, dtype=np.float32
    ...
    def step(self, action):
        ...
        p.setJointMotorControlArray(
            ...
            targetVelocities=[5.23] * self.JOINT_DIM,
    ...
    def reset(self):
        if self._physics_client_id < 0:
            ...
            # load soccerbot
            # p.loadURDF("/home/shahryar/catkin_ws/src/soccer_ws/bez1_description/models/soccerbot_stl.urdf",
            # p.loadURDF("/home/shahryar/PycharmProjects/DeepRL/gym-soccerbot/gym_soccerbot/bez1_description/models/soccerbot_stl.urdf",
            # "/home/shahryar/PycharmProjects/DeepRL/gym-soccerbot/gym_soccerbot/bez1_description/models/soccerbot_stl.urdf",
