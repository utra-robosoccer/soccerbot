...
class WalkingForwardV5(gym.Env):
    ...
    pose_limit = np.array([3.0] * _POSE_DIM)
    ...
    observation_limit_high = np.concatenate((joint_limit[_DIM_SUB_HANDS : Joints.HEAD_1], imu_limit, pose_limit, feet_limit))
    observation_limit_low = np.concatenate((-joint_limit[_DIM_SUB_HANDS : Joints.HEAD_1], -imu_limit, -pose_limit, -feet_limit))
