...
from soccer_strategy.old.robot_controlled_3d import RobotControlled3D
from soccer_strategy.old.robot_observed import RobotObserved
...
class GameEngine3D:
    ...
    def run(self):
        ...
        while not self.is_shutdown():
            ...
            # if type(self.strategy) != new_strategy: TODO fix maybe
