...
void Dynamixel_SetVelocity(Dynamixel_HandleTypeDef *hdynamixel, double velocity){
	 ...
	 *
	 * Arguments: hdynamixel, the motor handle
	 * 			  velocity, the goal velocity in RPM. Arguments of 0-114 are valid.
	 *
	 * Returns: none
	 */
}
...
// UNIMPLEMENTED
void Dynamixel_SetCWAngleLimit(Dynamixel_HandleTypeDef *hdynamixel, double minAngle, double maxAngle){
	/* Sets the clockwise angle limit for the current motor.
	 * Register 0x06 in EEPROM for min angle, 0x07 in EEPROM for max angle
	 *
	 * Arguments: hdynamixel, the motor handle
	 ...
	 *
	 * If minAngle for CCW angle limit (addr: 0x08) is 0 AND minAngle for CW angle limit (addr: 0x06) is 0,
...
// UNIMPLEMENTED
void Dynamixel_SetCCWAngleLimit(Dynamixel_HandleTypeDef *hdynamixel, double minAngle, double maxAngle){
	/* Sets the counter-clockwise angle limit for the current motor.
	 * Register 0x08 in EEPROM for min angle, 0x09 in EEPROM for max angle
	 *
	 * Arguments: hdynamixel, the motor handle
	 * 			  minAngle, the minimum angle for all motor operations. Arguments between 0 and 300 are valid
	 * 			  maxAngle, the maximum angle for all motor operations. Arguments between 0 and 300 are valid.
