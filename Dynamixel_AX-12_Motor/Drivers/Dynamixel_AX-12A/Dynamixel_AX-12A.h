...
void Dynamixel_SetCWAngleLimit(Dynamixel_HandleTypeDef *hdynamixel, double minAngle, double maxAngle); // (EEPROM) UNIMPLEMENTED
void Dynamixel_SetCCWAngleLimit(Dynamixel_HandleTypeDef *hdynamixel, double minAngle, double maxAngle); // (EEPROM) UNIMPLEMENTED
