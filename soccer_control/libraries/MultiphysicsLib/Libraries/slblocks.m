...
%
blkStruct.Name = ['Simscape Multibody Multiphysics Library'];
%
% The function that will be called when the user double-clicks on
% this icon.
%
blkStruct.OpenFcn = 'Multibody_Multiphysics_Lib';
...
%
blkStruct.MaskDisplay = 'Simscape Multibody Multiphysics Library';
...
Browser(1).Library = 'Multibody_Multiphysics_Lib';
Browser(1).Name    = 'Simscape Multibody Multiphysics Library';
