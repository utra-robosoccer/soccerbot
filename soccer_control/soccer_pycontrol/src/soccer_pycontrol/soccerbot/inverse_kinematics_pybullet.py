...
class InverseKinematicsPybullet:
    ...
    def ready(self) -> List[float]:
        ...
        # right leg
        # TODO revisit naming
        thetas = self.ik.ik_right_foot(np.copy(self.right_foot_init_position))
        ...
        # left leg
        thetas = self.ik.ik_left_foot(np.copy(self.left_foot_init_position))
