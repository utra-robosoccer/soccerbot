...
class StabilizeROS(Stabilize):
    def __init__(self):
        super(StabilizeROS, self).__init__(
            standing_pitch_kp=rospy.get_param("standing_pitch_kp", 0.1),
            standing_pitch_kd=rospy.get_param("standing_pitch_kd", 0.0),
            standing_pitch_ki=rospy.get_param("standing_pitch_ki", 0.000),
            standing_pitch_setpoint=rospy.get_param("standing_pitch_setpoint", -0.0),
            ...
            walking_pitch_kp=rospy.get_param("standing_roll_offset", 2.3),
            walking_pitch_kd=rospy.get_param("walking_pitch_kd", 1.0),
            walking_pitch_ki=rospy.get_param("walking_pitch_ki", 0.000),
