...
model_filename = expanduser("~") + "/catkin_ws/src/soccerbot/soccer_description/bez1_description/urdf/sigmaban/robot.urdf"
...
# Posture parameters
parameters.walk_com_height = 0.23  # Constant height for the CoM [m]
...
while True:
    ...
    if args.pybullet:
        ...
        if t <= -2:
            print("here")
            T_left_origin = sim.transformation("origin", "camera_frame")
            T_world_left = sim.poseToMatrix(([0.0, 0.0, 0.5], [0.0, 0.0, 0.0, 1.0]))
