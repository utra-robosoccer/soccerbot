...
class Test(TestCase):
    ...
    def test_annotate_ball(self, num_samples=1000):
        ...
        for i in range(num_samples):
            ...
            ball_angle_offset = random.uniform(-math.pi/6, math.pi/6)
            ...
            image = cv2.rectangle(image, pt1, pt2, color=(0, 0, 0), thickness=1)

            jsonPath = "../images/img{}_bb.json".format(i)
            with open(jsonPath, 'w') as f:
                json.dump((pt1, pt2), f)
            filePath = "../images/img{}.jpg".format(i)
