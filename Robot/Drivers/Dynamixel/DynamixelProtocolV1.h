...
/*************************** Library configuration ****************************/
 enum IO_FLAGS{IO_DMA, IO_POLL, IO_IT}; /*!< Enumerates the low-level I/O modes the library supports */

/****************************** Public Variables ******************************/
/* Buffer for data received from motors. */
extern uint8_t arrReceive[NUM_MOTORS][BUFF_SIZE_RX]; /*!< Pre-allocated buffer for reading in packets from motors */

/* Bytes to be transmitted to motors are written to this array. */
extern uint8_t arrTransmit[NUM_MOTORS + 1][TX_PACKET_SIZE]; /*!< Pre-allocated buffer for transmitting packets to motors */

// TODO: Delete the sync write array
/* Sync-writing position uses this array. */
extern uint8_t arrSyncWritePosition[NUM_UARTS][23]; /*!< Obsolete */
