...
\hline
{\em px\+Result} & The variable pointed to by px\+Result will be set to pd\+P\+A\+SS if data was successfully posted onto the queue, otherwise it will be set to an error defined within \mbox{\hyperlink{projdefs_8h_source}{Proj\+Defs.\+h}}.\\
\hline
\end{DoxyParams}
Example usage\+: 
\begin{DoxyPre}
