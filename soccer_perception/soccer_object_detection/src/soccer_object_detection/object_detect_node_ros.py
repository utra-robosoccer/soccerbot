...
class ObjectDetectionNodeRos(ObjectDetectionNode):
    ...
    def __init__(self, model_path):
        ...
        self.cover_horizon_up_threshold = self.get_param("cover_horizon_up_threshold", 30)
        ...
        # ROS
        self.pub_ball = self.create_publisher("/robot1/ball", PoseStamped, queue_size=1)
        self.pub_ball_pixel = self.create_publisher("/robot1/ball_pixel", Float32MultiArray, queue_size=1)
        self.pub_detection = self.create_publisher("/robot1/detection_image", Image, queue_size=1, latch=True)
        self.pub_boundingbox = self.create_publisher("/robot1/object_bounding_boxes", BoundingBoxes, queue_size=1, latch=True)
...
if __name__ == "__main__":
    ...
    self.init_node("object_detector")
